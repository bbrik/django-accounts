...
@msg_success_redirect(PASSWORD_CHANGE_REDIRECT_URL, 
                      _(u'Senha alterada com sucesso.'))
...
@msg_success_redirect(PASSWORD_RESET_REDIRECT_URL,
...
@msg_success_redirect(PASSWORD_RESET_REDIRECT_URL,
                      _(u'Senha redefinida com sucesso.'))
